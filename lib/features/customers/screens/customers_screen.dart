  ...
  Future<void> _loadCustomers() async {
    try {
      ...
      if (mounted) {
        ...
        _message('مش قادر أجيب العملاء: $e');
      }
    }
  }
  ...
  Future<void> _deleteCustomer(Customer customer) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text(
          'هل أنت متأكد من حذف "${customer.name}"؟ لا يمكن حذف عميل عليه رصيد أو معاملات سابقة.',
        ),
        actions: [
          TextButton(
    ...
    try {
      ...
      if (mounted) _message('تم حذف العميل');
    } catch (e) {
      if (mounted) {
            ...
            children: [
              ...
              Expanded(
                child: ActionButton(
                  ...
                  primary: false,
                  onTap: () async {
                    if (await Nav.push(context, const AddCustomerScreen()) ==
                        true) {
                      await _loadCustomers();
                    }
                  },
