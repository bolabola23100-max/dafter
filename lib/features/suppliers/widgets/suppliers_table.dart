          ...
          Container(
            ...
            child: const Row(
              children: [
                Expanded(
                  flex: 2,
                  child: Text('المورد', style: TextStyle(fontSize: 12, color: Colors.grey)),
                ),
                Expanded(
                  child: Text('رقم الهاتف', style: TextStyle(fontSize: 12, color: Colors.grey)),
                ),
                Expanded(
                  child: Text('المستحق', style: TextStyle(fontSize: 12, color: Colors.grey)),
                ),
                Expanded(
                  child: Text('الحالة', style: TextStyle(fontSize: 12, color: Colors.grey)),
                ),
