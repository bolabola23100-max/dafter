...
class PurchaseDocumentService {
          ...
          pw.Directionality(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                pw.Text(
                  'رقم الفاتورة: ${purchase.displayInvoiceNumber}',
                  style: pw.TextStyle(font: font),
                ),
                pw.Text(
                  'التاريخ: ${_date(purchase.date)}',
                  style: pw.TextStyle(font: font),
                ),
                pw.Text(
    ...
    return pw.TableRow(
      children: [
        pw.Padding(
          ...
          child: pw.Text(total, style: style, textAlign: pw.TextAlign.center),
        ),
        pw.Padding(
          padding: const pw.EdgeInsets.all(6),
          child: pw.Text(
        ...
        pw.Padding(
          padding: const pw.EdgeInsets.all(6),
          child: pw.Text(name, style: style, textAlign: pw.TextAlign.right),
        ),
      ],
    );
  }
  ...
  Future<bool> savePdf(Purchase purchase) async {
    final location = await getSaveLocation(
      suggestedName: 'فاتورة_شراء_${purchase.displayInvoiceNumber}.pdf',
    ...
    await XFile.fromData(
      bytes,
      name: 'فاتورة_شراء_${purchase.displayInvoiceNumber}.pdf',
